...
class WeatherReportGenerator:
    ...
    def draw_daily_temp_bars(self, year, month, readings):
        ...
        for reading in readings:
            ...
            # Red Bar (Max Temp)
            print(
                f"{reading.date.day:02d} {self.RED}{'+' * reading.max_temp}{self.RESET} {reading.max_temp}C"
            )
            # Blue Bar (Min Temp)
            print(
                f"{reading.date.day:02d} {self.BLUE}{'+' * reading.min_temp}{self.RESET} {reading.min_temp}C"
            )
